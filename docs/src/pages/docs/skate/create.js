...
export default skate('sk-page-docs-skate-create', {
  template () {
    this.innerHTML = `
      <sk-docs-layout>
        <h2><code>skate.create (name)</code></h2>
        <p>In order to get around <a href="/docs/native-polyfill-quirks.html">native / polyfill quirks</a>, and to provide a bit of sugar in how elements are created, Skate gives you a common way to create any type of element:</p>
